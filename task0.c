...
//      printf("\nThe size of short: %zu", sizeof(sh));
//      printf("\nThe size of int: %zu", sizeof(i));
//      printf("\nThe size of long: %zu", sizeof(l));
//      printf("\nThe size of long long: %zu", sizeof(ll));
//      printf("\nDecimal number: %d", dec);
//      printf("\nOctal number: 0%o", oct);
//      printf("\nHexa number (Lowercase): 0x%x", hex);
//      printf("\nHexa number (Uppercase): 0x%X\n", hex);
//      printf("%d\n", x);
...
Ask the user for a number and which bit to toggle
